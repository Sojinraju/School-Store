...
def student(request):
    ...
    if request.method == "POST":
        ...
        try:
            ...
            sn = Student(name=name, birth_date=birth_date, address=address, gender=gender, age=age, phone=phone,
                         email=email, department=department, purpose=purpose, course=course, note=note, pen=pen,
                         paper=paper)
            sn.save()
